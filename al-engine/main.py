...
async def initialize_experiment(config: Dict[str, Any]):
    ...
    try:
        result = await al_service.initialize_experiment(config)
        return result
...
async def get_next_sample():
    ...
    try:
        result = await al_service.get_next_sample()
        return result
    except Exception as e:
...
async def submit_label(sample_id: str, label: int):
    """Submit a label for a sample and update the model."""
    try:
        result = await al_service.submit_label(sample_id, label)
        return result
    except Exception as e:
...
async def get_metrics():
    ...
    try:
        result = await al_service.get_metrics()
        return result
    except Exception as e:
...
async def get_status():
    ...
    try:
        result = await al_service.get_status()
        return result
    except Exception as e:
